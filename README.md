...
- **Material + positional evaluation** — piece values, king safety, mobility, and pawn structure.
...
Unzip and launch. Source-build from Unity: open the project in Unity 2022+ and press play.
